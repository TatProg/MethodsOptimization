...
function_info = {
    "Three Hump Camel": "The function has three local minima. Plot it on the interval of [-2, 2] in order to see its key characteristics.\n\nGlobal minimum is in x(0, 0)",
    "Sphere": "The Sphere function has d local minima except for the global one. It is continuous, convex and unimodal.\n\nGlobal minimum is in x(0, ... ,0)",
